...
<template>
  <div class="h-full flex flex-col relative">
    <div
      class="flex justify-between items-end mb-6 pb-4 border-b border-gray-200 dark:border-gray-800"
    >
    ...
    <div class="flex-1 overflow-y-auto mb-6 pb-4">
      ...
      <div v-else-if="memberData">
        <div class="transition-opacity duration-200">
          <div v-if="isEditing">
            <EditMedlemForm
              :member="{ pid: selectedPid!, ...memberData }"
        ...
        <div class="w-full h-full mb-2 flex items-center justify-center">
          <UButton
            v-if="!isEditing && status === 'success'"
