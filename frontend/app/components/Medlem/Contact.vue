  ...
  <div v-if="!medlem.finalDate" class="space-y-3">
    ...
    <div class="space-y-2">
      <div class="flex items-center gap-3 text-sm">
        ...
        <span v-if="medlem.email" class="text-gray-900 dark:text-gray-200">{{
          medlem.email
        }}</span>
      ...
      <div class="flex items-center gap-3 text-sm">
        ...
        <span v-if="medlem.phoneNr" class="text-gray-900 dark:text-gray-200">{{
          medlem.phoneNr
        }}</span>
    ...
    <div class="space-y-4">
      <div class="flex gap-3">
        <div class="flex flex-col items-center">
          ...
          <div
            class="w-0.5 h-full bg-gray-200 dark:bg-gray-700"
            v-if="medlem.finalDate"
          ></div>
        </div>
        <div>
          ...
          <p class="text-sm font-medium">
            {{ formatDate(medlem.birthdate) || "Ukendt" }}
          </p>
        </div>
      </div>
      ...
      <div
        v-if="medlem.birthdate"
        class="bg-gray-50 dark:bg-gray-800/50 p-2 rounded-md text-xs text-gray-500"
      >
